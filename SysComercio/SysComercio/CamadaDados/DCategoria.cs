...
namespace CamadaDados
{
    public class DCategoria
    {
        ...
        public DCategoria(int Idcategoria, string Nome, string Descricao, string TextoBuscar, int idcategoria, string nome, string descricao, string textoBuscar)
        {
        ...
        public string Inserir(DCategoria Categoria)
        {
            ...
            try
            {
                ...
                //ParNome.Direction = ParameterDirection.Output;
        ...
        public string Editar(DCategoria Categoria)
        {
            ...
            try
            {
                ...
                //Eecutar o comando
                resp = SqlCmd.ExecuteNonQuery() == 1 ? "OK" : "A edição NÃO foi efetivada!";
        ...
        public string Excluir(DCategoria Categoria)
        {
            ...
            try
            {
                ...
                //Eecutar o comando
                resp = SqlCmd.ExecuteNonQuery() == 1 ? "OK" : "A exclusão NÃO foi efetivada!";
